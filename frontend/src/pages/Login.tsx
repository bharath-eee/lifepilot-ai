...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-bgDarker flex flex-col justify-center items-center p-6 relative overflow-hidden font-sans">
      ...
      {/* Main Login Frame */}
      <div className="w-full max-w-md p-8 md:p-10 rounded-2xl glass-panel relative border-white/[0.06] shadow-glass flex flex-col items-center">
        ...
        <div className="w-full space-y-4">
          <button 
            ...
            className="w-full flex items-center justify-center space-x-3 py-3.5 px-5 bg-white/5 border border-glassBorder rounded-xl text-slate-200 hover:text-white hover:bg-white/10 hover:border-neonBlue/30 transition-all font-medium group"
          >
