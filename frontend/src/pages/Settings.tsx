  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-slate-400 text-xs mt-1">Configure credentials, email polling frequencies, and orchestrator priorities.</p>
      </div>
      ...
      <div className="glass-panel p-6 rounded-2xl border-glassBorder space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center py-3 border-b border-glassBorder/40">
            <div>
              <p className="text-sm font-semibold text-slate-200">Email Sync Interval</p>
              <p className="text-xs text-slate-500">How frequently LifePilot polls Gmail for changes</p>
            </div>
            <select className="bg-[#05070C] text-slate-300 text-xs border border-glassBorder rounded-xl p-2.5 outline-none focus:border-neonBlue">
          ...
          <div className="flex justify-between items-center py-3 border-b border-glassBorder/40">
            <div>
              <p className="text-sm font-semibold text-slate-200">Active LLM Model</p>
